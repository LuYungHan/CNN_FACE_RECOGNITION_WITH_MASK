...
if __name__ == '__main__':
    ...
    for i in range(0,num,1):    
        ...
        image = cv2.imread(image_path +'LINE_ALBUM_Crop_icecream_220809_{}.jpg'.format(i), cv2.IMREAD_COLOR)
        ...
        # gen result
        save_path_img = ('api_usage/detect_17821/detect_17821_{}.jpg'.format(i))
        save_path_txt = ('api_usage/detect_17821/detect_17821_res_{}.txt'.format(i))
