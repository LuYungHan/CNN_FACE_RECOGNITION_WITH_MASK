...
if __name__ == '__main__':
    ...
    for j in range(0,num,1):
        ...
        image_det_txt_path = 'api_usage/detect_17821/'
        image = cv2.imread(image_path + 'LINE_ALBUM_Crop_icecream_220809_{}.jpg'.format(j), cv2.IMREAD_COLOR)
        ...
        try:
            for i, line in enumerate(lines):
                ...
                save_path_img = 'api_usage/landmark_17821/17821_' + 'landmark_res' + str(j) + '.jpg'
                save_path_txt = 'api_usage/landmark_17821/17821_mask_' + 'landmark_res' + str(j) + '.txt'
