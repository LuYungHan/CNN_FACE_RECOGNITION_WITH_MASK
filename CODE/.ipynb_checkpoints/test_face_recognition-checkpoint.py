...
# +
@torch.no_grad()
def inference(weight, name, img, file):
...
# ################################################################################# get feature 
    ...
    parser.add_argument('--img', type=str,default='api_usage/CCP_MI')
    parser.add_argument('--file', type=str, default='api_usage/all_face_feat_0819.csv')
