...
# +
@torch.no_grad()
def inference(net, img, file, threshold):
...
#################################################################################################### 歐式距離
                ...
                distances = np.sum(np.square(feat2 - compare_feat),axis = 1)
...
#     parser.add_argument('--weight', type=str, default='api_usage/work_dirs/ms1mv2_r50/model.pt')
    ...
    parser.add_argument('--threshold', type=int, default=1.7)
    
    args = parser.parse_args()
    args = parser.parse_args(args=[])
    predict_is_the_same = inference(args.net, args.img, args.file, args.threshold)
